...
Page_0_Home_UI = function() {
  tabPanel("Home",
           ...
           fluidPage(
             ...
             p("▶️ Input: Genome-wide biallelic SNP in Variant Call Format (VCF) file.", br(),
             ...
             p(HTML("Huang, Y.-H., Chen, L.-Y., Septiningsih, E. M., Kao, P.-H., & Kao, C.-F. (2025). <em>ShiNyP</em>: Unlocking SNP-based population genetics—An AI-assisted platform for rapid and interactive visual exploration. <em>Molecular Biology and Evolution, 43</em>(6), msaf117."),
