...
guide_input2 = reactiveVal("You can input ✅ data.frame or ✅ genlight files (in RDS) that have already been transformed.")
...
guide_AI = reactiveVal("This page allows you to 1️⃣ generate your preliminary results from prior analysis, 2️⃣ input your OpenAI API key, 3️⃣ select an AI model, and 4️⃣ get an AI-driven report.")
