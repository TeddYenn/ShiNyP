...
guide_SNPdensity = reactiveVal("Need to upload the ▶️ Site Info file (in RDS) and ▶️ Chromosome Info file (in CSV). \nPlease select the optimal window size and step, then click the 'Summary' button.")
...
guide_OutFLANK = reactiveVal("To run OutFLANK, the input data must be in ✅ genlight or ✅ genind format with 'Group Info.' \nYou also need to upload a ▶️ Site Info file (in RDS).\nPlease click the 'Run OutFLANK' button.")
...
guide_AI = reactiveVal("This page allows you to 1️⃣ generate your preliminary results from prior analysis, 2️⃣ use the API key uploaded on the Home page, and 3️⃣ get an AI-driven report.")
ai_user_api_key = reactiveVal(NULL)
ai_user_model = reactiveVal("Gemini 2.5 Flash-Lite")
