...
server = function(input, output, session) {
  ...
  output$SNPdensity_result1 = renderText({
    ...
    if (SNPdensity1() == "SNP Density Plot") {
      ...
      paste0("Number of chromosomes: ", length(Chr_Info[,1]), "\n",
  ...
  observeEvent(input$runGD, {
    ...
    if (!is.null(groupInfo3())){
      ...
      pre_results[[33]] = paste0("The average Unbiased pi diversity (Pi) of each group, Group 1 to Group ", length(group_stat[,6]), ": ", paste(group_stat[,6], collapse = ", "))
  ...
  observeEvent(input$runAIreport, {
    ...
    if (input$AI_prompt == "Summary Request"){
      ...
      Start = "Can you summarize the key findings from my SNP data analysis report?"
      ...
      Start = "What do you think the patterns observed in the SNP data suggest about the genetic variation?"
      ...
      Start = "Can you help me organize my SNP analysis report into sections for clarity and flow?"
      ...
      Start = "Can you help me brainstorm ideas for further analysis or experiments based on the findings in my SNP report?"
    } 
