...
ui = navbarPage(
  ...
  tabPanel("Home",
           fluidPage(
             ...
             p("Real-time Processing and Analyzing Large Genome-Wide Single Nucleotide Polymorphism (SNP) Datasets:",
             ...
             tags$ul(
               ...
               tags$li("Analyzed R serialization objects", style = "font-size: 16px;"),
               tags$li("Auto-generate preliminary results", style = "font-size: 16px;"),
